"""
Program to simulate the Ising model for one temperature value using either Glauber or Kawasaki dynamics
Takes in length N of lattice where the lattice is a square lattice of size N X N
Takes in value for temperature
...
Temperature, average energy, average |M|, specific heat, error in specific heat and susceptibility are written to file ObservableT.txt
...
J = 1.0
nstep = 10000              # Number of sweeps

# Input

if(len(sys.argv) != 3):
   print ("Usage python CP1.py N T")
   sys.exit()
